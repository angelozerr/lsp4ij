...
public class DAPClient implements IDebugProtocolClient, Disposable {
    ...
    private CompletableFuture<Void> initialize(@NotNull Map<String, Object> dapParameters,
        ...
        final var arguments = debugProcess.getClientFeatures().createInitializeRequestArguments(dapParameters);
    ...
    public CompletableFuture<Void> startDebugging(StartDebuggingRequestArguments args) {
        ...
        DAPClient client = new DAPClient(debugProcess, parameters, debugMode, debuggingType, serverTrace, this);
    ...
    public DAPClientFeatures getClientFeatures() {
        return debugProcess.getClientFeatures();
    }
