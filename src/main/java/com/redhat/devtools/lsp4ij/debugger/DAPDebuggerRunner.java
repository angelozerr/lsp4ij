...
public class DAPDebuggerRunner implements ProgramRunner<RunnerSettings> {

    private static final Logger LOG = Logger.getInstance(DAPDebuggerRunner.class);
                ...
                .startSession(environment, new XDebugProcessStarter() {
                    ...
                    public @NotNull XDebugProcess start(final @NotNull XDebugSession session) throws ExecutionException {
                        ...
                        try {
                            ...
                            final ExecutionResult executionResult = runProfileState.execute(environment.getExecutor(), DAPDebuggerRunner.this);
