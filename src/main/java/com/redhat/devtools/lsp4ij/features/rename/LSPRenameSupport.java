 ...
 * </ul>
 */
public class LSPRenameSupport extends AbstractLSPFeatureSupport<RenameParamsContext, List<WorkspaceEditData>> {

    private RenameParamsContext previousParams;

    public LSPRenameSupport(@NotNull PsiFile file) {
        super(file);
    }

    public CompletableFuture<List<WorkspaceEditData>> getRename(@NotNull RenameParamsContext params) {
    ...
    @Override
    protected CompletableFuture<List<WorkspaceEditData>> doLoad(@NotNull RenameParamsContext params,
                                                                @NotNull CancellationSupport cancellationSupport) {
        return getRename(params, cancellationSupport);
    }

    private static @NotNull CompletableFuture<List<WorkspaceEditData>> getRename(@NotNull RenameParamsContext params,
                                                                                 @NotNull CancellationSupport cancellationSupport) {
