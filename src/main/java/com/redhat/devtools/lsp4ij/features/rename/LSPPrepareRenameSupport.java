 ...
 * </ul>
 */
public class LSPPrepareRenameSupport extends AbstractLSPFeatureSupport<PrepareRenameParamsContext, List<PrepareRenameResultData>> {
    ...
    public CompletableFuture<List<PrepareRenameResultData>> getPrepareRenameResult(PrepareRenameParamsContext params) {
    ...
    @Override
    protected CompletableFuture<List<PrepareRenameResultData>> doLoad(@NotNull PrepareRenameParamsContext params,
    ...
    private static @NotNull CompletableFuture<List<PrepareRenameResultData>> getPrepareRenameResult(@NotNull VirtualFile file,
                                                                                                    ...
                                                                                                    @NotNull PrepareRenameParamsContext params,
                                                                                                    @NotNull CancellationSupport cancellationSupport) {
