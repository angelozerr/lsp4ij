 ...
 * </ul>
 */
public class LSPRefactoringCodeActionSupport extends AbstractLSPFeatureSupport<CodeActionParams, List<CodeActionData>> {

    public LSPRefactoringCodeActionSupport(@NotNull PsiFile file) {
        super(file);
    }
    ...
    private static @NotNull CompletableFuture<List<CodeActionData>> getDocumentLinks(@NotNull VirtualFile file,
        ...
        return LanguageServiceAccessor.getInstance(project)
                ...
                .thenComposeAsync(languageServers -> {
                    ...
                    List<CompletableFuture<List<CodeActionData>>> linkInformationPerServerFutures = languageServers
                            .stream()
