...
class RenameParamsContext extends RenameParams {
    ...
    public RenameParamsContext(TextDocumentIdentifier textDocument, Position position, List<LanguageServerItem> languageServers) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RenameParamsContext that)) return false;
