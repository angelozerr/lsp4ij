...
class DefaultPrepareRenameResultProvider implements Function<LanguageServerItem, PrepareRenameResultData> {
    ...
    private final PrepareRenameParamsContext prepareRenameParams;

    private TextRange textRange;

    private String placeholder;

    public DefaultPrepareRenameResultProvider(@NotNull PrepareRenameParamsContext prepareRenameParams) {
    ...
    public PrepareRenameParams getPrepareRenameParams() {
