...
class PrepareRenameParamsContext extends PrepareRenameParams {
    ...
    public PrepareRenameParamsContext(TextDocumentIdentifier textDocument, Position position, int offset, Document document) {
